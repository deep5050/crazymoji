...
var getKeys =
  ...
  return array;
    ...
    module.exports.flattern =
        (nested_array) => { return [].concat.apply([], nested_array); }
                  ...
                  return getKeys(emojis);
                    ...
                    () => {
                      ...
                      return sub_categories;
                          ...
                          module.exports.filter_by_category =
                        (category) => {
                          const data =
                              titleize(category).replace('Github', 'GitHub');
                          const categories = this.categories();
                          if (categories.includes(data)) {
                            return emojis[data];
                          } else {
                            throw new Error(
                                `crazymoji: Category \'${data}\' not found!`);
                          }
                        }
                                      ...
                                      module.exports
                                          .emojify = (sub_category) => {
                          var flattern = this.flattern(sub_category);
                          var text = [];
                          flattern.forEach(
                              element => { text.push(`:${element.trim()}:`); });
                          return text;
                        }